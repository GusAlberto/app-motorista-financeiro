  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-slate-950 py-20 px-4">
        ...
        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-8 mb-4">1. Introdução</h2>
        <p className="text-slate-600 dark:text-slate-300 mb-6">
          O app-motorista respeita sua privacidade. Esta política descreve como coletamos, usamos e protegemos seus dados.
        </p>

        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-8 mb-4">2. Dados que Coletamos</h2>
        ...
        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-8 mb-4">3. Como Usamos Seus Dados</h2>
        <p className="text-slate-600 dark:text-slate-300 mb-6">
        ...
        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-8 mb-4">4. Segurança</h2>
        <p className="text-slate-600 dark:text-slate-300 mb-6">
          Seus dados são criptografados e protegidos com RLS (Row Level Security). Apenas você pode acessá-los.
        </p>

        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-8 mb-4">5. Seus Direitos (LGPD)</h2>
        <p className="text-slate-600 dark:text-slate-300 mb-6">
          Você tem direito de:
        </p>
        <ul className="list-disc list-inside text-slate-600 dark:text-slate-300 mb-6">
        ...
        <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-8 mb-4">6. Contato</h2>
        <p className="text-slate-600 dark:text-slate-300 mb-6">
